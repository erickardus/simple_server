...
machine_options = {
  :bootstrap_options => {
    :cloud_service_name => 'erickardustxpabz',
    :storage_account_name => 'erickardustxpabz',
    :vm_size => "Standard_D1",
    :location => "West US",
    :tcp_endpoints => '80:80',
  },
...
machine_batch "cluster" do                   
    1.upto(2) do |i|    
        ...
        machine_options = {
          :bootstrap_options => {
            :cloud_service_name => "erickardusx#{i}",
            :storage_account_name => "erickardusy#{i}",
            :vm_size => "Standard_D1",
            :location => "West US",
            :tcp_endpoints => '80:80',
          },
